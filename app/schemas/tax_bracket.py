...
class ExtractedIncomeTaxBracket(BaseModel):
    source_record_id: Annotated[
        int,
        Field(validation_alias=AliasChoices("source_record_id", "record_id"), gt=0),
    ]
    ...
    income_max: Union[MoneyDecimal, Literal["NO_LIMIT"]]
    tax_rate: Union[Decimal, str]
